...
const UpdateSkill = (props) => {
  ...
  const { classes, handleCloseModel, skill, width } = props;
  const [loading, setLoading] = useState(false);
  const [skillCoverPhoto, setSkillCoverPhoto] = useState(skill.skillCoverPhoto);
  const [previewCoverPhoto, setPreviewCoverPhoto] = useState(
    skill.skillCoverPhoto
  );
  const imp = useRef();
  const [previewSKillCard, setPreviewSKillCard] = useState({});

  const [status, setStatus] = React.useState({
    skillIsTop: skill.skillIsTop,
    skillIsFeatured: skill.skillIsFeatured,
  });
  const initialValues = {
    skillName: skill.skillName,
    skillDescription: skill.skillDescription,
    skillWebsite: skill.skillWebsite,
    skillExperiance: skill.skillExperiance,
    skillPlatform: skill.skillPlatform,
  };
                          ...
                          <Grid item xs={12}>
                            ...
                            >
                              ...
                              <Select
                                ...
                                defaultValue={skill.skillExperiance}
                                onChange={handleChange}
                          ...
                          <Grid item xs={12}>
                            ...
                            >
                              ...
                              <Select
                                ...
                                defaultValue={skill.skillPlatform}
                                onChange={handleChange}
                          ...
                          <Grid item xs={12}>
                            ...
                            >
                              <TextField
                                ...
                                defaultValue={skill.skillWebsite}
                                onChange={handleChange}
                                onBlur={handleBlur}
                              />
                            </FormControl>
...
export default withStyles(MuiDistributor)(UpdateSkill);
